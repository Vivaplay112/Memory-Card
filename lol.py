...
questions_list.append(
        Question('ПРЕДУПРЕЖДЕНИЕ: ВОПРОСЫ МОГУТ ПОВТОРЯТЬСЯ!!!!', 'Окей', 'Ты чё, совсем?', 'Иди в баню', 'Ужас просто!!!!'))
questions_list.append(
        Question('Рифма к слову: человек', 'Чебурек', 'Картошка', 'Кабриолет', 'Смех'))
questions_list.append(
        Question('Как зовут бога грома у викингов?', 'Тор', 'Бор', 'Перун', 'Зевс'))
questions_list.append(
        Question('Самое прочное вещество', 'Графен', 'Сталь', 'Графит', 'Алмаз'))
